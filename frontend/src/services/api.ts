...
export const chatAPI = {
  getUsers: async () => apiService.get('/messages/users'),
  getConversation: async (contactId: number) => apiService.get(`/messages/${contactId}`),
};

export const adminAPI = {
  getAllMessages: async () => apiService.get('/admin/messages'),
  banMessage: async (id: number, isBanned: boolean) => apiService.patch(`/admin/messages/${id}/ban`, { isBanned }),
};
